...
Every DS project should start by a phase called Exploratory Data Analysis, which often times include various visualisations such as the ones described above.
...
## Limitations of data-based models
...
## The Two Cultures 
```{r statistical-vs-machine-learning, echo = FALSE, fig.cap='Visualising the difference between Statistical and Machine Learning.'}
knitr::include_graphics("resources/02-observer/statistical-vs-machine-learning.png")
```
